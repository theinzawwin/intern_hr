        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmergencyNo = table.Column<int>(nullable: false),
                    AccountNo = table.Column<int>(nullable: false),
                    ATMNumber = table.Column<int>(nullable: false),
                    IsActive = table.Column<bool>(nullable: false),
                    CreatedDate = table.Column<DateTime>(nullable: false),
                    CreatedBy = table.Column<string>(nullable: true),
                    EmployeeProfile = table.Column<string>(nullable: true),
                    BranchId = table.Column<long>(nullable: false),
                    DepartmentId = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Document_EmployeeInfo_EmployeeInfoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Document_EmployeeInfoId",
                table: "Document",
